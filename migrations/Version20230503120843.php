 ...
 */
final class Version20230503120843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article_categories (id INT AUTO_INCREMENT NOT NULL, categories_id INT NOT NULL, articlespress_id INT NOT NULL, blog_id INT NOT NULL, INDEX IDX_62A97E9A21214B7 (categories_id), INDEX IDX_62A97E985691D81 (articlespress_id), INDEX IDX_62A97E9DAE07E97 (blog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE articlespress (id INT AUTO_INCREMENT NOT NULL, ess_id INT NOT NULL, title LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7A1DCBE1B703B605 (ess_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE blog (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_C015514367B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE comments (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, articlepress_id INT NOT NULL, ess_id INT NOT NULL, blog_id INT NOT NULL, comment LONGTEXT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_5F9E962A67B3B43D (users_id), INDEX IDX_5F9E962A2DDE3D97 (articlepress_id), INDEX IDX_5F9E962AB703B605 (ess_id), INDEX IDX_5F9E962ADAE07E97 (blog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contact_messages (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_41278201E7927C74 (email), INDEX IDX_4127820167B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ess (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, name_structure VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip_code VARCHAR(5) NOT NULL, sector_activity VARCHAR(255) NOT NULL, legal_status VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, phone_number VARCHAR(20) NOT NULL, image VARCHAR(255) DEFAULT NULL, web_site VARCHAR(255) DEFAULT NULL, social_networks VARCHAR(255) DEFAULT NULL, opening_hours_monday TIME NOT NULL, closing_hours_monday TIME NOT NULL, opening_hours_tuesday TIME NOT NULL, closing_hours_tuesday TIME NOT NULL, opening_hours_wednesday TIME NOT NULL, closing_hours_wednesday TIME NOT NULL, opening_hours_thursday TIME NOT NULL, closing_hours_thursday TIME NOT NULL, opening_hours_friday TIME NOT NULL, closing_hoursfriday TIME NOT NULL, opening_hours_saturday TIME NOT NULL, closing_hours_saturday TIME NOT NULL, opening_hours_sunday TIME NOT NULL, closing_hours_sunday TIME NOT NULL, region VARCHAR(255) NOT NULL, label JSON DEFAULT NULL, siret_number VARCHAR(14) NOT NULL, activity VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_7C43DA6AE7927C74 (email), INDEX IDX_7C43DA6AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

const mapForm = document.querySelector('#detailsMap');
...
if (mapForm) {
    ...
    function mapClickListen(e) {
        ...
        document.querySelector("#ess_form_geoLocalisationEss_latitude").value = pos.lat;
        document.querySelector("#ess_form_geoLocalisationEss_longitude").value = pos.lng;
    }
    /**
     * 
     * @param {*} pos 
        ...
        xmlhttp.onreadystatechange = () => {
            ...
            if (xmlhttp.readyState == 4) {
                ...
                if (xmlhttp.status == 200) {
                    ...
                    document.querySelector("#ess_form_geoLocalisationEss_latitude").value = lat;
                    document.querySelector("#ess_form_geoLocalisationEss_longitude").value = lon;
